...
public class SendEmail implements SendEmailInterface {
    ...
    public void send(Email email) {
        String template = "<!DOCTYPE html>\n"
                ...
                + "            <center>\n"
                + "              <img src='http://observatoriocreativo.cl/images/oec_logo_blanco_horizontal.png' width='200' height='' alt='alt_text' border='0' align='center' class='fluid' style='width: 100%; max-width: 400px; height: auto; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555; align-content: center; margin-top: 35px; margin-bottom: 35px;'>\n"
                + "            </center>\n"
                + "          </td>\n"
                + "        </tr>\n"
                + "        <tr>\n"
                ...
                + "                  <br>\n"
                + "                  <p id=\"team\">Emendare SpA.</p>\n"
                + "                  <!--\n"
                + "                  <table role='presentation' cellspacing='0' cellpadding='0' border='0' align='center' style='margin: auto'>\n"
                + "                    <tr>\n"
                + "                      <td style='border-radius: 3px; background: #4d7900; text-align: center;' class='button-td'>\n"
                + "                        <a href='http://localhost/password?system=svc&tkn=' style='background: #4d7900; border: 15px solid #4d7900; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;'\n"
                + "                          class='button-a'>\n"
                + "                          <span style='color:#ffffff;' class='button-link'>&nbsp;&nbsp;&nbsp;&nbsp;Configurar mi contraseña&nbsp;&nbsp;&nbsp;&nbsp;</span>\n"
                + "                        </a>\n"
                + "                      </td>\n"
                + "                    </tr>\n"
                + "                  </table>\n"
                ...
                + "                    Observatorio de Economía Creativa\n"
                + "                  </td>\n"
                + "                </tr>\n"
                + "              </table>\n"
                + "            </div>\n"
                ...
                + "            <br>\n"
                + "            <br>Emendare SpA - 2018\n"
                + "            <br>Valdivia, Región de Los Ríos, Chile.\n"
                + "            <br>contacto@emendare.cl\n"
                + "          </td>\n"
                + "        </tr>\n"
                + "    </div>\n"
                + "  </center>\n"
