 ...
 * Brugge Framework.
 */
package io.codeffeine.brugge.persistence.storage;

import io.codeffeine.brugge.persistence.exception.DeletingException;
import static io.codeffeine.brugge.persistence.storage.StoragePath.BASE_PATH;
import io.codeffeine.brugge.persistence.storage.exception.FileStorageException;
import java.io.File;
