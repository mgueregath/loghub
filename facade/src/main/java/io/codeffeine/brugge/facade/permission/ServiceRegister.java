...
import io.codeffeine.brugge.usecase.keeper.CounterKeeper;
...
public class ServiceRegister {
    ...
    public void registerServices() {
        ...
        Set<Class<?>> protectedServices = new Reflections("io.codeffeine.brugge.facade.service").getTypesAnnotatedWith(ProtectedService.class);
