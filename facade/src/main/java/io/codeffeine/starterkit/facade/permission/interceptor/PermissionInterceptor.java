 ...
 * StarterKit.
 */
package io.codeffeine.starterkit.facade.permission.interceptor;
...
public class PermissionInterceptor {
    ...
    @Pointcut("execution(@io.codeffeine.starterkit.facade.permission.annotation.Permission * *(..))")
    ...
    @AfterThrowing(pointcut = "execution(* io.codeffeine.starterkit.facade..service..*(..))", throwing = "e")
    public void exception(JoinPoint joinPoint, Throwable e) {
        logActions(joinPoint, false, e);
    }

    @AfterReturning("execution(* io.codeffeine.starterkit.facade..service..*(..))")
